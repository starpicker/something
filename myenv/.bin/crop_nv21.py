...
for file in NV21_List:
    for size in size_dict:
        ...
        if file.find(width_before_crop and height_before_crop) !=-1:
            ...
            print ("crop_nv21.sh "+ os.path.join(dir,file) + " " +os.path.join(dir,new_name) + " 0 0 " + width_after_crop + " " + height_after_crop)
            #os.system ("crop_nv21.sh"+ os.path.join(dir,file)  + " " +os.path.join(dir,new_name) + " 0 0 " + pixel_right_side + " " + pixel_bottom_side)
            os.system ("crop_nv21.sh "+ os.path.join(dir,file)  + " " +os.path.join(dir,new_name) + " 0 0 " + width_after_crop + " " + height_after_crop)
