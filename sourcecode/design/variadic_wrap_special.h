...
namespace ml_variadic_wrap_special
{
namespace detail
{
template <typename T>
...
class A3
{
    friend A<A3>;
private:
    int special(int a){return ::special(a);}
};
...
public:
    ...
    template <typename ...Args>
    int special(Args ...args)
    {
        t.special(forward<Args>(args)...);
    }
